...
def community_list(request):
    ...
    return render(request, 'nutrients_codi/community_list.html', context)
...
def community_detail(request, post_id):
    ...
    return render(request, 'nutrients_codi/community_detail.html', context)
...
def community_create(request):
    ...
    return render(request, 'nutrients_codi/community_form.html', context)
