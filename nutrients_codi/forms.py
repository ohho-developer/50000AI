...
class ProfileForm(forms.ModelForm):
    ...
    class Meta:
        ...
        help_texts = {
            'height': _('정확한 키를 입력해주세요 (100-250cm)'),
            'weight': _('현재 체중을 입력해주세요 (30-300kg)'),
        }
...
class FoodAnalysisForm(forms.Form):
    ...
    food_text = forms.CharField(
        ...
        widget=forms.Textarea(attrs={
            ...
            'placeholder': _('예: 아침은 굶었고 점심에 제육덮밥, 저녁엔 삼겹살 2인분에 소주 한 병 마셨어요'),
            'rows': 4,
        }),
        help_text=_('자연어로 편하게 입력해주세요. AI가 분석하여 영양 정보를 제공합니다.'),
        max_length=1000
    )
